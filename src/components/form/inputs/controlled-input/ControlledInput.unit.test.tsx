...
describe('ControlledInput', () => {
    ...
    it('should handle input change', () => {
        ...
        expect(dispatch.mock.calls[0][0]).toEqual(setFieldValue('test', 'value-test'));
        expect(dispatch.mock.calls[1][0]).toEqual(setFieldError('test', 'validate-error'));
    ...
    it('should handle input blur', () => {
        ...
        expect(dispatch.mock.calls[0][0]).toEqual(setFieldError('test', 'validate-error'));
